    ...
    <div className="flex min-h-screen flex-col justify-between bg-gray-50">
      <div className="p-4 space-y-6">
        <header className="text-center space-y-1">
          <h1 className="text-3xl font-bold text-[#101518]">Customer Service Kiosk</h1>
          <p className="text-[#101518]">Submit requests for refunds, order status, or admin support.</p>
        </header>
        <TicketForm />
      </div>
      <footer className="border-t bg-gray-50 p-4 flex justify-around text-[#5c748a]">
